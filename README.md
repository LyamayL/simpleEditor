# simpleEditor
🇫🇷 - Éditeur de Mosaïque — Projet d’Introduction à l’Informatique Graphique (L1, Université Paris-Saclay)
...
🇬🇧 - Mosaic Editor — Introduction to Computer Graphics Project (1st Year, Paris-Saclay University)
